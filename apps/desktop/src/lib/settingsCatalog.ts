...
export function getSettingsCatalog(zh: boolean): SettingsSearchEntry[] {
  return [
    ...
    { id: "type", section: "appearance", label: zh ? "阅读排版" : "Reading typography", description: zh ? "正文、界面、代码字号与字重" : "Reading, interface, and code size", keywords: ["font", "字体", "字号", "字重", "宽度", "正文"] },
    { id: "ui", section: "appearance", label: zh ? "界面大小" : "Interface size", description: zh ? "侧栏、标题栏、按钮和设置的缩放" : "Scale sidebar, title bar, buttons, and settings", keywords: ["ui", "界面", "缩放", "侧栏", "按钮", "chrome"] },
    { id: "codeType", section: "appearance", label: zh ? "代码字体" : "Code font", description: zh ? "代码字号与等宽字体" : "Code size and monospace family", keywords: ["code", "mono", "代码", "等宽", "jetbrains", "cascadia"] },
    { id: "fonts", section: "appearance", label: zh ? "字体" : "Fonts", description: zh ? "界面字体、代码字体与自定义字体名" : "UI font, code font, and custom family names", keywords: ["font family", "pingfang", "苹方", "宋体", "楷体"] },
    { id: "colors", section: "appearance", label: zh ? "颜色与背景" : "Colors and background", description: zh ? "背景、面板、文字、强调色与代码背景" : "Background, panel, text, accent, and code background", keywords: ["color", "background", "颜色", "背景", "强调", "accent", "palette"] },
