...
const paths: Record<string, JSX.Element> = {
  ...
  gear: (
    <>
      <path d="M9.7 3.2h4.6l.7 2.4 1.4.8 2.4-.6 2.3 4-1.7 1.8v1.6l1.7 1.8-2.3 4-2.4-.6-1.4.8-.7 2.4H9.7L9 19.2l-1.4-.8-2.4.6-2.3-4 1.7-1.8v-1.6L2.9 9.8l2.3-4 2.4.6L9 5.6l.7-2.4z" />
